      ...
      <div className="ab">
        <div className="main-container d-flex">
          <div className="sidebar" id="side_nav">
            ...
            <li>
              <NavLink to="/hello">Receive Product</NavLink>
            </li>
              ...
              <li>
              <NavLink to="/hello">View Response</NavLink>
            </li>
            <li>
              <NavLink to="/hello">View Medicine</NavLink>
            </li>
            </ul>
            ...
            <li>
              <NavLink to="/hello">View Raw Material</NavLink>
                ...
                <li classname=""><a href="#" classname="text-decoration-none"><i classname="fal fa-bell"></i> Create Medicine </a></li>
              </ul>
          </div>
