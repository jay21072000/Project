        ...
        <div className="main-container d-flex">
          <div className="sidebar" id="side_nav">
            ...
            <ul classname="list-unstyled px-2">
              ...
              <li>
              <NavLink to="/hello">Admin</NavLink>
            </li>
            <li>
              <NavLink to="/hello">Supplier</NavLink>
            </li>
              ...
              <li>
              <NavLink to="/hello">Manufacture</NavLink>
            </li>
            <li>
              <NavLink to="/hello">Transporter</NavLink>
            </li>
            </ul>
            ...
            <li>
              <NavLink to="/hello">Wholesaler</NavLink>
            </li>
                <li classname=""><a href="#" classname="text-decoration-none"><i classname="fal fa-bell"></i> Notifications </a></li>
              </ul>
          </div>
